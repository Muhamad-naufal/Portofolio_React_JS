...
const Nav = () => {
  return <div className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
    <div class="container mx-auto">
      <div className='w-full bg-black/20 h-[96px] backdrop-blur-2x1 rounded-full max-w-[460px] mx-auto px-5 justify-between items-center flex text-2x1 text-white/50'>
        <Link activeClass='active' offset={-200} smooth={true} spy={true} to='home' className='cursor-pointer w-[60px] h-[60px] flex items-center justify-center'>
          <BiHomeAlt />
        </Link>
